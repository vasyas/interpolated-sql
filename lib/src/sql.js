...
var Sql = /** @class */ (function () {
    ...
    Sql.prototype.first = function (def) {
        if (def === void 0) { def = undefined; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.one(def)];
            });
        });
    };
    ...
    Sql.prototype.prepareQueryParams = function () {
        return this.params
            .map(function (p) { return p === undefined ? null : p; })
    ...
    Sql.prototype.prevNextIds = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var rowNums, rowNum, rows, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        rowNums = this.wrap(sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n            select id, rowNum\n            from (\n                select @rowNum := @rowNum + 1 as rowNum, id\n                from \n                    (select @rowNum := 0) as i,\n                    ("], ["\n            select id, rowNum\n            from (\n                select @rowNum := @rowNum + 1 as rowNum, id\n                from \n                    (select @rowNum := 0) as i,\n                    ("]))), sql(templateObject_5 || (templateObject_5 = __makeTemplateObject([") as t ) as rowNums"], [") as t ) as rowNums"]))));
                        return [4 /*yield*/, rowNums
                                .append("where id = " + id)
                                .one()];
                    case 1:
                        rowNum = (_c.sent()).rowNum;
                        if (!(rowNum == 1)) return [3 /*break*/, 3];
                        _b = (_a = [
                            { id: null }
                        ]).concat;
                        return [4 /*yield*/, rowNums
