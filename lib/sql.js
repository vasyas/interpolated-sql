...
var Sql = /** @class */ (function () {
    ...
    Sql.prototype.getQueryParams = function () {
        return this.params
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.execute(this.getQuery(), this.getQueryParams())];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.query(this.getQuery(), this.getQueryParams())];
                    case 2:
                        r = (_a.sent())[0];
